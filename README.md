...
The server route will try both `/pipeline/...` and `/api/pipeline/...` paths automatically, and can fall back to legacy captions endpoints if pipeline routes are unavailable.
